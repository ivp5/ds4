...
typedef struct ds4_d8f_i8_codebook_record {
    uint32_t expert;
    uint32_t k;
    uint32_t dtype;
    uint32_t flags;
...
typedef struct ds4_d8f_file {
    ...
    uint64_t down_i8_codebook_sidecar_table_offset;
    uint32_t down_i8_codebook_sidecar_record_bytes;
    uint32_t down_i8_codebook_sidecar_records;
    uint32_t down_i8_codebook_sidecar_count;
    ...
    ds4_d8f_i8_codebook_record down_i8_codebooks[256];
} ds4_d8f_file;
