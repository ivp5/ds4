...
| `DeepSeek-V4-Flash_H3371_H3216_budget_repair_no_overlay_D8F_800kctx_20260603` | Rebuild target; allocator predicts ~51.60 GB with current metadata + non-routed pack extras | General-fidelity rebuild target, **not locally encoded yet** | `tools/ds4_h3371_allocator.py` regenerates the non-AIME policy from H3216: demote L40-L42 down records to K512 and demote the 186 weakest L40 down rows to K256; this explicitly reverses H3384's late-down overprotection and is now the next pack to encode/coherence-gate |
