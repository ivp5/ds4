...
| `DeepSeek-V4-Flash_H3372_H3371_late_route_hot_gateup_repair_D8F_800kctx_20260604` | Rebuild target; allocator predicts ~51.64 GB with current metadata + non-routed pack extras | Current general-fidelity rebuild target, **not locally fully encoded yet** | Agent2 identified the echo-causing loss as gate/up. `tools/ds4_h3371_allocator.py --late-hot-gateup-threshold 0.02` keeps H3371's late-down budget repair but promotes 40 L40-L42 route-hot gate/up records to K2048/K4096, leaving ~357 MB decimal margin under 52 GB. L40/E104 canary improves gate/up rel-L2 from H3371 K256/K256 `0.572/0.573` to K2048/K4096 `0.450/0.414`, slightly better than H3384 on the same expert. |
| `DeepSeek-V4-Flash_H3371_H3216_budget_repair_no_overlay_D8F_800kctx_20260603` | Rebuild target; allocator predicts ~51.60 GB with current metadata + non-routed pack extras | Superseded by H3372 gate/up repair | `tools/ds4_h3371_allocator.py` regenerates the non-AIME policy from H3216: demote L40-L42 down records to K512 and demote the 186 weakest L40 down rows to K256. Audit found it left the L40-L42 route-hot gate/up records at K256/K256, matching Agent2's gate/up-loss diagnosis. |
