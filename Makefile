...
METAL_LDLIBS := $(LDLIBS) -framework Foundation -framework Metal -framework MetalPerformanceShadersGraph $(JOURNAL_LIB)
...
CORE_OBJS = ds4.o ds4_neon_i8mm.o ds4_metal.o ds4_mpsgraph.o ds4_expert_table.o ds4_inflight.o ds4_moe_route_log.o ds4_polar_reader.o ds4_vqb1_reader.o $(LEGACY_CODEC_OBJS) ds4_watersic_pack.o ds4_nonrouted_pack.o ds4_d8m_reader.o ds4_d8f_reader.o ds4_d8fs_reader.o ds4_prefix_cache.o $(JOURNAL_OBJ)
CPU_CORE_OBJS = ds4_cpu.o ds4_neon_i8mm.o ds4_inflight.o ds4_polar_reader.o ds4_vqb1_reader.o $(LEGACY_CODEC_CPU_OBJS) ds4_watersic_pack.o ds4_nonrouted_pack.o ds4_d8m_reader.o ds4_d8f_reader.o ds4_d8fs_reader.o ds4_prefix_cache.o $(JOURNAL_OBJ)
else
...
CORE_OBJS = ds4.o ds4_neon_i8mm.o ds4_cuda.o ds4_polar_reader.o ds4_vqb1_reader.o ds4_d8m_reader.o ds4_d8f_reader.o ds4_d8fs_reader.o $(LEGACY_CODEC_CPU_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_neon_i8mm.o ds4_polar_reader.o ds4_vqb1_reader.o ds4_d8m_reader.o ds4_d8f_reader.o ds4_d8fs_reader.o $(LEGACY_CODEC_CPU_OBJS)
METAL_LDLIBS := $(LDLIBS)
endif
...
ds4_d8fs_reader.o: ds4_d8fs_reader.c ds4_d8fs_reader.h
	$(CC) $(CFLAGS) -c -o $@ ds4_d8fs_reader.c

ds4_cdx3_reader.o: ds4_cdx3_reader.c ds4_cdx3_reader.h
	$(CC) $(CFLAGS) -c -o $@ ds4_cdx3_reader.c

ds4_cli.o: ds4_cli.c ds4.h linenoise.h ds4_d8f_reader.h ds4_d8fs_reader.h
...
ds4_cli_cpu.o: ds4_cli.c ds4.h linenoise.h ds4_d8fs_reader.h
...
ds4_mpsgraph.o: ds4_mpsgraph.m ds4_gpu.h ds4_d8f_reader.h
	$(CC) $(OBJCFLAGS) -c -o $@ ds4_mpsgraph.m
