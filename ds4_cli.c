...
static void usage(FILE *fp) {
    fprintf(fp,
        ...
        "      prefer D8F classic in-graph packet ICB and keep external MTL4\n"
        "      packet dispatch force-only.\n"
        ...
        "      Q head RMSNorm+RoPE, KV RoPE+FP8/raw-store, decode attention+\n"
        "      inverse-RoPE, indexed attention+inverse-RoPE, FP8 attention-output\n"
