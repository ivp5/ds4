...
static void usage(FILE *fp) {
    fprintf(fp,
        ...
        "      KV RoPE+FP8/raw-store and FP8 shared-down HC fusion are default-on;\n"
        "      disable with DS4_METAL_DISABLE_KV_ROPE_STORE_FUSION=1 and\n"
        "      DS4_METAL_DISABLE_SHARED_DOWN_FP8_HC_FUSION=1. Decode/indexed\n"
        "      attention inverse-RoPE, decode HC norm, and fused router select are\n"
        "      opt-in canaries: DS4_METAL_ENABLE_DECODE_ATTN_ROPE_FUSION=1,\n"
        "      DS4_METAL_ENABLE_INDEXED_ATTN_ROPE_FUSION=1,\n"
        "      DS4_METAL_ENABLE_HC_NORM_FUSION=1,\n"
        "      DS4_METAL_ENABLE_ROUTER_SELECT_FUSION=1.\n"
